...
export async function createOrFindAssistant() {
  try {
    const assistant = await openai.beta.assistants.retrieve("asst_ZEf0lz8NwEE7Us1uYaB0QAx4")
     if (assistant) return assistant
    return openai.beta.assistants.create({
      name: "Expert Travel Guide",
      instructions: `you are an assistant that answers questions based on provided knowledge files. provide resource links and answer with maximum details with knowledge based url.`,
      tools: [
        {
          type: "function",
          function: {
