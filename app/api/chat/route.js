...
import { siteSearch } from "../search_api";
...
async function handleToolCall(functionName, functionArgs) {
  if (functionName === "siteSearch") {
    const results = await siteSearch(functionArgs.query, functionArgs.latitude, functionArgs.longitude)
